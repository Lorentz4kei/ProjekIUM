<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="absolute z-40 flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-[#012619] border-r border-[#035949] transition-transform duration-300 ease-in-out lg:static lg:translate-x-0">
    ...
    <div class="flex flex-col flex-1 mt-6">
        <nav class="space-y-1">
            ...
            <!-- Bookings -->
            <a class="group flex items-center px-4 py-3 text-gray-300 hover:bg-[#035949] hover:text-white rounded-xl transition duration-200 border-l-4 border-transparent hover:border-gray-500"
            ...
            <!-- Payments -->
            <a class="group flex items-center px-4 py-3 text-gray-300 hover:bg-[#035949] hover:text-white rounded-xl transition duration-200 border-l-4 border-transparent hover:border-gray-500" href="{{ route('admin.payments.index') }}">
                <svg class="w-5 h-5 group-hover:text-[#30BF62] transition duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
