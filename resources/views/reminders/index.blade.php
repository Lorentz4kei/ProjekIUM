...
<div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
    ...
    <a href="/reminders/settings" class="bg-[#035949] text-white hover:bg-[#012619] rounded-xl px-4 py-2 text-sm font-medium transition shadow-sm flex items-center w-full sm:w-auto justify-center">
