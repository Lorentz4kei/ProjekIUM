...
<div class="py-20 bg-[#F2F2F2]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            @for ($i = 0; $i < 3; $i++)
            <!-- Room Card -->
            <div class="bg-white rounded-2x1 shadow-md overflow-hidden hover:shadow-lg transition duration-200 group">
                <div class="relative overflow-hidden h-48">
                    <img src="{{ asset('images/rooms1.jpg') }}" class="w-full h-full object-cover group-hover:scale-105 transition duration-300">
                    <div class="absolute top-4 right-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-[#012619] shadow-sm">Tersedia</div>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-[#012619] mb-1">Kamar {{ $i+1 }}</h3>
                    <p class="text-[#30BF62] font-semibold mb-4">Rp 500,000 <span class="text-sm font-normal text-gray-500">/ Bulan</span></p>
                    
                    <div class="flex flex-wrap gap-2 mb-6 text-sm text-gray-600">
                        <span class="bg-gray-100 px-2 py-1 rounded-md">Kipas angin</span>
                        <span class="bg-gray-100 px-2 py-1 rounded-md">WiFi</span>
                        <span class="bg-gray-100 px-2 py-1 rounded-md">Kamar mandi luar</span>
                    </div>
