        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl p-4 shadow-md">
                    <img src="https://placehold.co/800x400/e2e8f0/475569?text=Main+Room+View" class="w-full h-80 object-cover rounded-xl mb-4">
                ...
                <div class="bg-white rounded-2xl shadow-md p-8">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <h1 class="text-3xl font-bold text-[#012619] mb-2">VIP Room Suite</h1>
                            <p class="text-gray-500">Mapple Street No. 4, City Center</p>
                        </div>
                        <span class="bg-green-100 text-[#188C4A] px-3 py-1 rounded-full text-sm font-bold">1 Left</span>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-8">
                        <span class="bg-gray-100 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium flex items-center"><svg class="w-4 h-4 mr-1 text-[#30BF62]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> AC</span>
                        <span class="bg-gray-100 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium flex items-center"><svg class="w-4 h-4 mr-1 text-[#30BF62]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Private Bath</span>
                        <span class="bg-gray-100 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium flex items-center"><svg class="w-4 h-4 mr-1 text-[#30BF62]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Hot Water</span>
                        <span class="bg-gray-100 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium flex items-center"><svg class="w-4 h-4 mr-1 text-[#30BF62]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Smart TV</span>
                        <span class="bg-gray-100 text-gray-700 px-4 py-2 rounded-xl text-sm font-medium flex items-center"><svg class="w-4 h-4 mr-1 text-[#30BF62]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Weekly Cleaning</span>
                    </div>

                    <h2 class="text-xl font-semibold mb-4 text-[#012619] border-b border-gray-100 pb-2">Description</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Experience the ultimate comfort in our VIP Room Suite. Designed with modern aesthetics and fully furnished with high-quality materials. Enjoy a quiet, productive environment suitable for professionals. Features a spacious private bathroom and complimentary weekly room cleaning services.
                    </p>
                </div>
            </div>
